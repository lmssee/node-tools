...
const t = "\x1b[", { stdout, stdin } = process;
 ...
 */
const cursorMoveUp = (numberOfUpwardMoves: number = 1) => _p(`${numberOfUpwardMoves}A`);
 ...
 */
const cursorMoveDown = (numberOfMovesDown: number = 1) => _p(`${numberOfMovesDown}B`);
 ...
 */
const cursorMoveLeft = (numberOfLeftShifts: number = 1) => _p(`${numberOfLeftShifts}D`);
 ...
 */
const cursorMoveRight = (numberOfRightShifts: number = 1) => _p(`${numberOfRightShifts}C`);
